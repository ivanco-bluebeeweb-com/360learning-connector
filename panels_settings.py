"""Settings panel for 360Learning Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__threesixty_learning_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=threesixty_learning_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_threesixty_learning"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("360Learning Settings & Accounts", level=2),
