"""HTTP client for 360Learning (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.threesixty_learning.com"

class ThreeSixtyLearningClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-threesixty_learning/0.1.0"
        }
