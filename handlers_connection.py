"""Connection lifecycle for 360Learning Connector."""
...
_SECRET = "threesixty_learning_connections"
...
@chat.function(
    "connect_threesixty_learning",
    "Connect 360Learning account via credentials.",
    action_type="write",
    chain_callable=True,
    event="360learning-connector.connect_threesixty_learning",
    effects=["create:connection"],
    data_model=ConnectParams
)
async def connect_threesixty_learning(params: ConnectParams, ctx) -> ActionResult[ConnectionRecord]:
    """Connect 360Learning Connector."""
    ...
    record = {
        "id": cid,
        "label": params.label or "360Learning Account",
...
@chat.function(
    "list_connections",
    "List connected 360Learning accounts.",
    action_type="read",
    chain_callable=True,
    data_model=NoParams
)
...
@chat.function(
    "disconnect_threesixty_learning",
    "Disconnect 360Learning account.",
    action_type="write",
    chain_callable=True,
    event="360learning-connector.disconnect_threesixty_learning",
    effects=["delete:connection"],
    data_model=ConnectionIdParams
)
async def disconnect_threesixty_learning(params: ConnectionIdParams, ctx) -> ActionResult[DeleteResult]:
    conns = await _load_connections(ctx)
